...
- **Use the repo's default branch.** Branch from and [submit your pull request](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/creating-a-pull-request-from-a-fork) to the repo's default branch. Usually this is `main`, but it could be something else.
...
1. If applicable, prefix the title with the relevant component name. (examples: "docs: Fix typo", "chore: Refactor ...")
...
Most of this document was adapted from [@jessesquires](https://github.com/jessesquires)]. Thank you for your hard work and dedication to the open-source community!
